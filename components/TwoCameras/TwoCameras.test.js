...
describe('components', () => {
  describe('TwoCameras', () => {
    it('should mount with props', function () {
      const wrap = mount(<TwoCameras>Hello World</TwoCameras>)
    ...
    it('should render as type and with content', function () {
      const wrap = render(<TwoCameras>Hello World</TwoCameras>)

      expect(wrap[0].type).toEqual('tag')
      expect(wrap[0].name).toEqual('div')
      // contain styles
      expect(wrap[0].attribs.class).toContain('two_cameras')
